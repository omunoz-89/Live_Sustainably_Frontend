...
const Plants = (props) => {
  ...
  const [plants, setPlants] = useState(
    <button className="button is-loading" id="loading">
      Loading
    </button>
  );
                ...
                <div className="card-content">
                  ...
                  <div class="plant-content content">
                    <p>
                      ...
                      Tempore dolorum excepturi, pariatur dolore fuga
                      perferendis mollitia deserunt a voluptas assumenda!
                      Consequatur beatae qui dolorem tempora possimus
                      accusantium, fugit eius quidem?
                    </p>
                  </div>
                </div>
  ...
  return (
    <div>
      {searchBar}
      <div className="columns is-multiline">{plants}</div>
    </div>
  );
};
